...
_FUNCTION(Tcl_GetDoubleFromObj) \
_FUNCTION(Tcl_GetBoolean) \
_FUNCTION(Tcl_GetBooleanFromObj) \
_FUNCTION(Tcl_GetLongFromObj) \
_FUNCTION(Tcl_GetWideIntFromObj) \
...
_FUNCTION(Tcl_CreateObjCommand) \
